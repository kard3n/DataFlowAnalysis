...
public class BehaviorItemProvider extends EntityItemProvider {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(datadictionaryPackage.Literals.BEHAVIOR__IN_PIN,
				datadictionaryFactory.eINSTANCE.createPin()));

		newChildDescriptors.add(createChildParameter(datadictionaryPackage.Literals.BEHAVIOR__OUT_PIN,
				datadictionaryFactory.eINSTANCE.createPin()));
