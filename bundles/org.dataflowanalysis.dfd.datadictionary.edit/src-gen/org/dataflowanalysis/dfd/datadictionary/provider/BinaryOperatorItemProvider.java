...
public class BinaryOperatorItemProvider extends TermItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_BinaryOperator_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(datadictionaryPackage.Literals.BINARY_OPERATOR__TERMS,
