	...
	protected void addOutputLabelsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_SetAssignment_outputLabels_feature",
								"_UI_SetAssignment_type"),
						datadictionaryPackage.Literals.SET_ASSIGNMENT__OUTPUT_LABELS, true, false, true, null, null,
						null));
	}
