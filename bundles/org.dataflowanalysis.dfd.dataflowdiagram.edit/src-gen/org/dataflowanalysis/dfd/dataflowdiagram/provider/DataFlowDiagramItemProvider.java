...
public class DataFlowDiagramItemProvider extends EntityItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_DataFlowDiagram_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(dataflowdiagramPackage.Literals.DATA_FLOW_DIAGRAM__FLOWS,
				dataflowdiagramFactory.eINSTANCE.createFlow()));

		newChildDescriptors.add(createChildParameter(dataflowdiagramPackage.Literals.DATA_FLOW_DIAGRAM__NODES,
