 ...
 * </p>
 * <ul>
 *   <li>{@link org.dataflowanalysis.privacy.consent_model.impl.DataItemImpl#getState <em>State</em>}</li>
 *   <li>{@link org.dataflowanalysis.privacy.consent_model.impl.DataItemImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataItemImpl extends EntityImpl implements DataItem {
	...
	protected EClass eStaticClass() {
		return Consent_modelPackage.Literals.DATA_ITEM;
	}
	...
	public EList<DataState> getState() {
		if (state == null) {
			state = new EObjectResolvingEList<DataState>(DataState.class, this, Consent_modelPackage.DATA_ITEM__STATE);
		}
		return state;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Consent_modelPackage.DATA_ITEM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Consent_modelPackage.DATA_ITEM__STATE:
			return getState();
		case Consent_modelPackage.DATA_ITEM__NAME:
			return getName();
		}
