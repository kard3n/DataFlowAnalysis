 ...
 * </p>
 * <ul>
 *   <li>{@link org.dataflowanalysis.privacy.consentmodel.impl.ConsentLabelTypeImpl#getLabels <em>Labels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConsentLabelTypeImpl extends AbstractLabelTypeImpl implements ConsentLabelType {
	...
	protected EClass eStaticClass() {
		return consentmodelPackage.Literals.CONSENT_LABEL_TYPE;
	}
	...
	public EList<ConsentLabel> getLabels() {
		if (labels == null) {
			labels = new EObjectContainmentEList<ConsentLabel>(ConsentLabel.class, this,
					consentmodelPackage.CONSENT_LABEL_TYPE__LABELS);
		}
		return labels;
	}
