...
/**
 * This is the item provider adapter for a {@link org.dataflowanalysis.privacy.privacymodel.Functionality} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionalityItemProvider extends EntityItemProvider {
	...
	protected void addRequiresPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Functionality_requires_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Functionality_requires_feature",
								"_UI_Functionality_type"),
						privacymodelPackage.Literals.FUNCTIONALITY__REQUIRES, true, false, true, null, null, null));
	}
	...
	protected void addExcludesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Functionality_excludes_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Functionality_excludes_feature",
								"_UI_Functionality_type"),
						privacymodelPackage.Literals.FUNCTIONALITY__EXCLUDES, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(privacymodelPackage.Literals.FUNCTIONALITY__ALLOWS_FOR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(privacymodelPackage.Literals.FUNCTIONALITY__ALLOWS_FOR,
				privacymodelFactory.eINSTANCE.createUserDataCombination()));
	}
