 ...
 * </p>
 * <ul>
 *   <li>{@link org.dataflowanalysis.privacy.privacymodel.impl.DataContextLabelImpl#getDataContext <em>Data Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataContextLabelImpl extends AbstractLabelImpl implements DataContextLabel {
	...
	protected EClass eStaticClass() {
		return privacymodelPackage.Literals.DATA_CONTEXT_LABEL;
	}
	...
	public NotificationChain basicSetDataContext(DataContext newDataContext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					privacymodelPackage.DATA_CONTEXT_LABEL__DATA_CONTEXT, oldDataContext, newDataContext);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDataContext != dataContext) {
			...
			if (dataContext != null)
				msgs = ((InternalEObject) dataContext).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - privacymodelPackage.DATA_CONTEXT_LABEL__DATA_CONTEXT, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, privacymodelPackage.DATA_CONTEXT_LABEL__DATA_CONTEXT,
