 ...
 * </p>
 * <ul>
 *   <li>{@link org.dataflowanalysis.privacy.privacymodel.impl.DataStateLabelImpl#getDataState <em>Data State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataStateLabelImpl extends AbstractLabelImpl implements DataStateLabel {
	...
	protected EClass eStaticClass() {
		return privacymodelPackage.Literals.DATA_STATE_LABEL;
	}
	...
	public NotificationChain basicSetDataState(DataState newDataState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					privacymodelPackage.DATA_STATE_LABEL__DATA_STATE, oldDataState, newDataState);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDataState != dataState) {
			...
			if (dataState != null)
				msgs = ((InternalEObject) dataState).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - privacymodelPackage.DATA_STATE_LABEL__DATA_STATE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, privacymodelPackage.DATA_STATE_LABEL__DATA_STATE,
