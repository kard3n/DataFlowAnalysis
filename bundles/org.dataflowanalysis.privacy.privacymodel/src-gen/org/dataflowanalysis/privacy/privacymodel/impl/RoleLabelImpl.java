 ...
 * </p>
 * <ul>
 *   <li>{@link org.dataflowanalysis.privacy.privacymodel.impl.RoleLabelImpl#getRole <em>Role</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoleLabelImpl extends AbstractLabelImpl implements RoleLabel {
	/**
	...
	protected EClass eStaticClass() {
		return privacymodelPackage.Literals.ROLE_LABEL;
	}
	...
	public NotificationChain basicSetRole(Role newRole, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					privacymodelPackage.ROLE_LABEL__ROLE, oldRole, newRole);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRole != role) {
			...
			if (role != null)
				msgs = ((InternalEObject) role).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - privacymodelPackage.ROLE_LABEL__ROLE, null, msgs);
			if (newRole != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, privacymodelPackage.ROLE_LABEL__ROLE, newRole,
					newRole));
	}
