...
public class AssignmentsTest {
    ...
    public void testTFGBuildingWithSetAssignments() {
        ...
        DFDTestUtil.createAndAddAssignment(a, null, null, dataDictionary.getLabelTypes()
                .get(0)
                .getBasicLabels().stream().map(label -> (Label) label).toList(), null, SetAssignment.class);
    ...
    public void testSetAndUnsetBehavior() {
        ...
        DFDTestUtil.createAndAddAssignment(a, null, null, dataDictionary.getLabelTypes()
                .get(0)
                .getBasicLabels().stream().map(label -> (Label) label).toList(), null, UnsetAssignment.class);
